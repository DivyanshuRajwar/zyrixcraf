...
const DataCompo = () => {
  return (
    <div className="h-screen w-screen bg-[#dfdcd960] flex items-center justify-center p-4  space-y-20 ">
      <div className="h-[95%] w-[95%] max-w-none flex flex-col items-center justify-center  shadow-2xl bg-[#bdb9b698] rounded-[100px]  gap-6 font-[Poppins] text-center p-8">
