...
function Services({ overlayOn, setOverlay }) {
  ...
  return (
    ...
    >
      ...
      <div id="services-cards" className="w-full h-[70%] p-5 flex gap-2">
        {/* Web Development Card */}
        <div
          id="web-card"
          onClick={() => setOverlay(!overlayOn)}
          className="w-[450px] relative overflow-hidden rounded-4xl"
        >
          <div
          ...
          >
            ...
            <hr />
            <div id="btn" className="flex gap-2">
              <span className="bg-[#d3c5c5b2] p-2 rounded-4xl">ReactJs</span>
              <span className="bg-[#d3c5c5b2] p-2 rounded-4xl">ExpressJs</span>
        ...
        >
          ...
          >
            ...
            <hr />
            <div className="flex gap-2">
              <span className="bg-[#d3c5c5b2] p-2 rounded-4xl">Adobe Photoshop</span>
              <span className="bg-[#d3c5c5b2] p-2 rounded-4xl">CorelDRAW</span>
