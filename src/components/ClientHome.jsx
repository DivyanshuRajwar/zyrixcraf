...
const ClientHome = ({setOverlay}) => {
  return (
    <div className="fixed z-101 inset-0  w-full h-screen flex items-center justify-center shadow-lg overflow-hidden">
      ...
      <div className="w-1/2 h-screen font-serif  bg-[#f1dbdb] p-5 ">
        ...
        <i onClick={()=> setOverlay(false)} className="fi fi-br-cross absolute right-10 bg-[#b39a9a3d] h-15 w-15 flex justify-center items-center rounded-full hover:scale-[1.1] hover:cursor-pointer hover:bg-black hover:text-white transition-all duration-500 ease-in-out "></i>
  ...
  Submit the request <i class="fi fi-rr-arrow-small-right mt-2 text-2xl "></i>
</button>
