...
const ClientHome = ({ setOverlay }) => {
  ...
  return (
    <div className="fixed z-101 inset-0 w-full h-screen flex items-center justify-center shadow-lg overflow-hidden">
      {/* Left Section */}
      <div id="left" className="w-1/2 h-screen bg-[#f1dbdbea] flex flex-col gap-2 justify-center items-center">
      ...
      {/* Right Section (Form) */}
      <div id="right" className="w-1/2 h-screen font-serif bg-[#f1dbdb] p-5">
